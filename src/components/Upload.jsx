...
import { UploadIcon, Check, ImageIcon, Film, FileText, X, Plus } from "lucide-react"
          ...
          >
            ...
            >
              <button className="bg-[#8a2be2] hover:bg-[#7a1bd2] text-white px-8 py-4 rounded-full text-lg shadow-lg transition-all hover:shadow-xl flex items-center">
                <UploadIcon className="mr-2 h-5 w-5" /> Start Uploading
              </button>
            </motion.div>
          </motion.div>
            ...
            >
              <div className="text-center py-8">
                ...
                <label htmlFor="file-upload" className="cursor-pointer flex flex-col items-center">
                  <UploadIcon className="h-12 w-12 text-[#8a2be2] mb-4" />
